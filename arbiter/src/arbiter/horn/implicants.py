...
Negation is restricted to EDB predicates (see chain.py). Under the
...
counterfactual module (counterfactual.py) reports *retracting* that fact as
part of the delta, computed as a set-difference against the case's actual
observed facts, not against this offline artifact.
"""
...
from .proof import Fact, FactStatus
